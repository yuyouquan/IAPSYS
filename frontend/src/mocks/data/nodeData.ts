...
export const mockChannelApplyData: Record<string, ChannelApplyFormData> = {
  'APP-001': {
    ...
    appType: 'Weather',
    versionCode: 'v2.1.0',
    apkFileName: 'weather-pro-2.1.0.apk',
  ...
  'APP-002': {
    ...
    versionCode: 'v5.0.1',
    apkFileName: 'hios-launcher-5.0.1.apk',
    testReport: '',
  ...
  'APP-003': {
    ...
    appType: 'Shopping',
    versionCode: 'v3.2.0',
    apkFileName: 'palm-store-3.2.0.apk',
  ...
  'APP-004': {
    ...
    appType: 'Finance',
    versionCode: 'v1.5.0',
    apkFileName: 'smart-finance-1.5.0.apk',
  ...
  'APP-005': {
    ...
    appType: 'Education',
    versionCode: 'v4.0.0',
    apkFileName: 'edu-learn-4.0.0.apk',
    testReport: '',
  ...
  'APP-006': {
    ...
    appType: 'Medical',
    versionCode: 'v1.0.0',
    apkFileName: 'smart-health-1.0.0.apk',
  ...
  'APP-007': {
    ...
    appType: 'Entertainment',
    versionCode: 'v8.0.0',
    apkFileName: 'boomplay-8.0.0.apk',
  ...
  'APP-008': {
    ...
    versionCode: 'v6.2.0',
    apkFileName: 'phoenix-browser-6.2.0.apk',
  ...
  'APP-009': {
    ...
    appType: 'Business',
    versionCode: 'v3.5.0',
    apkFileName: 'carlcare-3.5.0.apk',
    testReport: '',
...
export const mockMaterialData: Record<string, MaterialFormData[]> = {
  'APP-001': [
    ...
    {
      langCode: 'fr', langName: '法语',
      appNameI18n: 'Weather Pro',
      shortDesc: 'Prévisions météo précises pour l\'Afrique et au-delà.',
      productDetail: 'Weather Pro fournit des prévisions météo hyper-locales avec des prédictions horaires et sur 7 jours.',
      updateNote: 'v2.1.0: Amélioration de la précision des prévisions.',
      keywords: ['météo', 'prévision', 'pluie', 'température', 'climat'],
      iconUrl: '', topImageUrl: '', screenshotUrls: [],
    },
    {
      langCode: 'sw', langName: '斯瓦西里语',
      appNameI18n: 'Weather Pro',
      shortDesc: 'Utabiri sahihi wa hali ya hewa kwa Afrika na zaidi.',
      productDetail: 'Weather Pro inatoa utabiri wa hali ya hewa wa eneo kwa saa na siku 7.',
      updateNote: 'v2.1.0: Kuboresha usahihi wa utabiri.',
      keywords: ['hali ya hewa', 'utabiri', 'mvua', 'joto'],
      iconUrl: '', topImageUrl: '', screenshotUrls: [],
    },
    {
      langCode: 'ar', langName: '阿拉伯语',
      appNameI18n: 'ويذر برو',
      shortDesc: 'توقعات جوية دقيقة لأفريقيا وخارجها.',
      productDetail: 'يوفر Weather Pro توقعات جوية محلية للغاية مع تنبؤات بالساعة ولمدة 7 أيام.',
      updateNote: 'الإصدار 2.1.0: تحسين دقة التنبؤات.',
      keywords: ['طقس', 'توقعات', 'مطر', 'حرارة'],
      iconUrl: '', topImageUrl: '', screenshotUrls: [],
    },
  ],
  'APP-002': [
  ...
  'APP-008': [
    ...
    {
      langCode: 'hi', langName: '印地语',
      appNameI18n: 'फीनिक्स ब्राउज़र',
      shortDesc: 'तेज़, सुरक्षित और डेटा बचाने वाला ब्राउज़र।',
      productDetail: 'फीनिक्स ब्राउज़र इन-बिल्ट एड ब्लॉकर, डेटा कम्प्रेशन और डाउनलोड मैनेजर के साथ तेज़ और सुरक्षित ब्राउज़िंग अनुभव प्रदान करता है।',
      updateNote: 'v6.2.0: ब्राउज़र इंजन अपग्रेड, बेहतर रेंडरिंग स्पीड।',
      keywords: ['ब्राउज़र', 'वेब', 'तेज़', 'सुरक्षित'],
      iconUrl: '', topImageUrl: '', screenshotUrls: [],
    },
    {
      langCode: 'id', langName: '印尼语',
      appNameI18n: 'Phoenix Browser',
      shortDesc: 'Browser cepat, aman, dan hemat data.',
      productDetail: 'Phoenix Browser memberikan pengalaman browsing yang cepat dan aman dengan pemblokir iklan bawaan, kompresi data, dan pengelola unduhan.',
      updateNote: 'v6.2.0: Peningkatan mesin browser, kecepatan rendering lebih baik.',
      keywords: ['browser', 'web', 'cepat', 'aman'],
      iconUrl: '', topImageUrl: '', screenshotUrls: [],
    },
  ],
  'APP-009': [
...
export const mockAppVersions: Record<string, AppVersion[]> = {
  'APP-001': [
    { versionCode: 'v2.1.0', versionName: '2.1.0', apkFileName: 'weather-pro-2.1.0.apk', apkSize: 45678912, buildTime: '2026-02-28T10:00:00Z', isUsedInCurrentFlow: true },
  ...
  'APP-002': [
    { versionCode: 'v5.0.1', versionName: '5.0.1', apkFileName: 'hios-launcher-5.0.1.apk', apkSize: 67890123, buildTime: '2026-03-01T10:00:00Z', isUsedInCurrentFlow: true },
  ...
  'APP-003': [
    { versionCode: 'v3.2.0', versionName: '3.2.0', apkFileName: 'palm-store-3.2.0.apk', apkSize: 56789012, buildTime: '2026-02-25T10:00:00Z', isUsedInCurrentFlow: true },
  ...
  'APP-004': [
    { versionCode: 'v1.5.0', versionName: '1.5.0', apkFileName: 'smart-finance-1.5.0.apk', apkSize: 34567890, buildTime: '2026-03-02T10:00:00Z', isUsedInCurrentFlow: true },
  ...
  'APP-005': [
    { versionCode: 'v4.0.0', versionName: '4.0.0', apkFileName: 'edu-learn-4.0.0.apk', apkSize: 51234567, buildTime: '2026-03-03T10:00:00Z', isUsedInCurrentFlow: true },
  ...
  'APP-006': [
    { versionCode: 'v1.0.0', versionName: '1.0.0', apkFileName: 'smart-health-1.0.0.apk', apkSize: 28901234, buildTime: '2026-03-04T10:00:00Z', isUsedInCurrentFlow: true },
  ],
  'APP-007': [
    { versionCode: 'v8.0.0', versionName: '8.0.0', apkFileName: 'boomplay-8.0.0.apk', apkSize: 89012345, buildTime: '2026-03-04T10:00:00Z', isUsedInCurrentFlow: true },
  ...
  'APP-008': [
    { versionCode: 'v6.2.0', versionName: '6.2.0', apkFileName: 'phoenix-browser-6.2.0.apk', apkSize: 62345678, buildTime: '2026-03-04T10:00:00Z', isUsedInCurrentFlow: true },
  ...
  'APP-009': [
    { versionCode: 'v3.5.0', versionName: '3.5.0', apkFileName: 'carlcare-3.5.0.apk', apkSize: 40123456, buildTime: '2026-03-04T10:00:00Z', isUsedInCurrentFlow: true },
